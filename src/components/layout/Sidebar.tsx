...
import { Scale, Home, Calendar, FileText, History, Settings, ChevronRight, FolderOpen, Archive, BarChart3, Users, GraduationCap, Gavel, X, ShieldAlert } from '@/components/Icons';
